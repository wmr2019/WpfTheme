...
using WTLib.DependencyInjection.Internal;
...
namespace WTLib.DependencyInjection
{
    public abstract partial class ObjectResolver : IObjectResolver
    {
        ...
        public void Compile()
        {
            if (isCompiled) throw new IocContainerResolverException("Already compiled, can not compile twice.");
        ...
        {
            if (!isCompiled) throw new IocContainerResolverException("Not yet compiled, you can access only after compile.");
        ...
        {
            Register<TInterface, TImplementation>(DependencyInjection.Lifestyle.Transient);
        }
        ...
        public void RegisterSingleton<TInterface, TImplementation>()
            ...
            where TImplementation : class, TInterface
        {
            Register<TInterface, TImplementation>(DependencyInjection.Lifestyle.Singleton);
        }
        ...
        {
            if (isCompiled) throw new IocContainerResolverException("Already compiled, can not register new type when compile finished.");
        ...
        public void RegisterCollection<TInterface>(params Type[] implementationTypes)
            where TInterface : class
        {
            RegisterCollection<TInterface>(DependencyInjection.Lifestyle.Transient, implementationTypes);
        }
        ...
        public object Resolve(Type type)
        {
            ...
            throw new IocContainerResolverException("Type was not dound, Type: " + type.FullName);
        }
