...
*   文件名称 ：ChineseParser.cs
*   =================================
*   创 建 者 ：mingrui.wu
*   创建日期 ：7/12/2022 3:51:02 PM 
*   功能描述 ：
*   使用说明 ：
*   =================================
*   修 改 者 ：
...
namespace ThemeMetro.Common
{
    ...
    {
        private readonly static string ls_second_eng = "" +
        ...
        private readonly static string ls_second_ch = "亍丌兀丐廿卅丕亘丞鬲孬噩丨禺丿匕乇夭爻卮氐囟胤馗毓睾鼗丶亟" +
        ...
        public static string GetSpellCode(string code)
        {
            ...
            {
                var charSpell = GetCharSpellCode(code.Substring(i, 1));
                if (charSpell != null)
                    spell.Append(charSpell);
            }
            return spell.ToString();
        }

        private static string GetCharSpellCode(string code)
        {
            // 二级汉字无法解析
            if (string.IsNullOrEmpty(code))
                return null;

            byte[] codeByte = Encoding.Default.GetBytes(code);
            if (codeByte.Length == 1)// 如果是字母，则直接返回
                return code.ToUpper();

            int i1 = (short)(codeByte[0]);
            int i2 = (short)(codeByte[1]);
        ...
        public static string GetFirstLetter(string chinese)
        {
            ...
            {
                var coding = Encoding.GetEncoding(936);
                if (coding == null)
                    return "";
                array = coding.GetBytes(chinese[i].ToString());
                //非汉字
                if (array[0] < 176)
                {
                    return_py += chinese[i];
                ...
                {
                    long iCnChar = array[0] * 256 + array[1];
                    if ((iCnChar >= 45217) && (iCnChar <= 45252)) { return_py += "A"; }
                    else if ((iCnChar >= 45253) && (iCnChar <= 45760)) { return_py += "B"; }
                    else if ((iCnChar >= 45761) && (iCnChar <= 46317)) { return_py += "C"; }
                    else if ((iCnChar >= 46318) && (iCnChar <= 46825)) { return_py += "D"; }
                    else if ((iCnChar >= 46826) && (iCnChar <= 47009)) { return_py += "E"; }
                    else if ((iCnChar >= 47010) && (iCnChar <= 47296)) { return_py += "F"; }
                    else if ((iCnChar >= 47297) && (iCnChar <= 47613)) { return_py += "G"; }
                    else if ((iCnChar >= 47614) && (iCnChar <= 48118)) { return_py += "H"; }
                    else if ((iCnChar >= 48119) && (iCnChar <= 49061)) { return_py += "J"; }
                    else if ((iCnChar >= 49062) && (iCnChar <= 49323)) { return_py += "K"; }
                    else if ((iCnChar >= 49324) && (iCnChar <= 49895)) { return_py += "L"; }
                    else if ((iCnChar >= 49896) && (iCnChar <= 50370)) { return_py += "M"; }
                    else if ((iCnChar >= 50371) && (iCnChar <= 50613)) { return_py += "N"; }
                    else if ((iCnChar >= 50614) && (iCnChar <= 50621)) { return_py += "O"; }
                    else if ((iCnChar >= 50622) && (iCnChar <= 50905)) { return_py += "P"; }
                    else if ((iCnChar >= 50906) && (iCnChar <= 51386)) { return_py += "Q"; }
                    else if ((iCnChar >= 51387) && (iCnChar <= 51445)) { return_py += "R"; }
                    else if ((iCnChar >= 51446) && (iCnChar <= 52217)) { return_py += "S"; }
                    else if ((iCnChar >= 52218) && (iCnChar <= 52697)) { return_py += "T"; }
                    else if ((iCnChar >= 52698) && (iCnChar <= 52979)) { return_py += "W"; }
                    else if ((iCnChar >= 52980) && (iCnChar <= 53640)) { return_py += "X"; }
                    else if ((iCnChar >= 53689) && (iCnChar <= 54480)) { return_py += "Y"; }
                    else if ((iCnChar >= 54481) && (iCnChar <= 55289)) { return_py += "Z"; }
                }
                //二级汉字
                else if (array[0] >= 215)
                {
                    var startIndex = ls_second_ch.IndexOf(chinese[i].ToString(), 0);
                    if (startIndex >= 0)
                        return_py += ls_second_eng.Substring(startIndex, 1);
                }
            }
