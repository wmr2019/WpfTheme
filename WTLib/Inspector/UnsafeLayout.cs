...
namespace WTLib.Inspector
{
    ...
    public static class UnsafeLayout
    {
            ...
            where T : struct
        {
            ...
            Padder.AddPaddings(true, System.Runtime.CompilerServices.Unsafe.SizeOf<T>(), fieldsLayout.OrderBy(x => x.Offset).ToArray(), layouts);
            return layouts;
        }
        ...
        private class NullableTwiddler
        {
            ...
            {
                ref var hasValue = ref System.Runtime.CompilerServices.Unsafe.Add(
                    ref System.Runtime.CompilerServices.Unsafe.As<T, byte>(ref seed), hasValueOffset);
                hasValue = 1;
            }
        }
        ...
        private static RootNode GetLayoutTree<T>() where T : struct
        {
            ...
            var root = new FieldNode
            {
                ...
                rootNode = new RootNode
                {
                    children = fields,
                    totalOffset = 0,
                    size = System.Runtime.CompilerServices.Unsafe.SizeOf<T>()
                }
            };
            var previous = 0;
        ...
        {
            T seed = default;
            ref var seedByteRef = ref System.Runtime.CompilerServices.Unsafe.As<T, byte>(ref seed);
            ...
            for (int i = 0; i < size; i++)
            {
                System.Runtime.CompilerServices.Unsafe.InitBlock
                    (ref System.Runtime.CompilerServices.Unsafe.As<T, byte>(ref seed), 0, (uint)size); // zero, including paddings
                ...
                seedByteRef = ref System.Runtime.CompilerServices.Unsafe.Add(ref seedByteRef, 1);
            }
